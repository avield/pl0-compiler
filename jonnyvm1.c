...
// The entire process-address-space. pas[0..] holds instructions; pas[..499] is the stack.
...
int main(int argc, char *argv[])
{
    ...
    // 4) Read triples (OP, L, M) into pas[], starting at index 0
    i = 10;
    while (1) {
    ...
    while (running) {
        ...
        IR[0] = pas[PC];      // real opcode is stored as (op + 1)
        IR[1] = pas[PC + 1];
        IR[2] = pas[PC + 2];
        PC += 3;
        ...
        // ... (the rest of your tracing/printing logic stays unchanged) ...
